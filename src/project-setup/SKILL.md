...
4. 使用 `proxy.ts` 而不是 `middleware.ts`，否则会有警告：`The "middleware" file convention is deprecated. Please use "proxy" instead. Learn more: https://nextjs.org/docs/messages/middleware-to-proxy`

5. 更新 `AGENTS.md` 添加国际化相关说明

### 步骤 7: 配置 lint

根据 https://github.com/antfu/eslint-config 配置 eslint，在配置中需要添加以下配置：
